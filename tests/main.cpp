...
TEST_CASE("emulation", "[emulation][.]") {
    ...
    SECTION("ppu") {
        RUN_TEST_ROMS(
            ...
            // Note: window_bg_reprise_wx15 is affected also by window_retrigger_pixel_glitch scenario
            ...
            // Note: window_bg_reprise_wx23 is affected also by window_retrigger_pixel_glitch scenario
