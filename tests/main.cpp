...
TEST_CASE("emulation", "[emulation][.]") {
    ...
    SECTION("ppu") {
        RUN_TEST_ROMS(
            ...
            //                GREY_PALETTE}, F{"mealybug/m3_scx_high_5_bits.gb", "mealybug/m3_scx_high_5_bits.png",
            //                GREY_PALETTE}, F{"mealybug/m3_scx_low_3_bits.gb", "mealybug/m3_scx_low_3_bits.png",
