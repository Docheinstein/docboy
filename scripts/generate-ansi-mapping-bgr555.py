...
"""
Script for generate the all the possible mappings between a BGR555 and ANSI color codes (256 colors)

usage: python generate-ansi-mapping-bgr555
"""
...
if __name__ == "__main__":
    ...
    for rgb555 in range(2**16):
        ...
        bgr555_to_ansi_indexes.append(best_color_idx)

    array = "{" + ",\n".join([f"0x{p:04X}" for p in bgr555_to_ansi_indexes]) + "}"
    print(array)
