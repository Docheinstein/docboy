...
ARGUMENTUM_INLINE CommandConfig ParameterConfig::add_command(std::shared_ptr<CommandOptions> pOptions) {
    if (!pOptions)
...
ARGUMENTUM_INLINE VoidOptionConfig ParameterConfig::add_help_option(const std::string& name,
...
ARGUMENTUM_INLINE OptionConfig ParameterConfig::tryAddParameter(Option& newOption,
...
ARGUMENTUM_INLINE OptionConfig ParameterConfig::addPositional(Option&& newOption,
...
ARGUMENTUM_INLINE OptionConfig ParameterConfig::addOption(Option&& newOption,
                                                          const std::vector<std::string_view>& names) {
...
ARGUMENTUM_INLINE void ParameterConfig::trySetNames(Option& option, const std::vector<std::string_view>& names) const {
    for (auto name : names) {
...
ARGUMENTUM_INLINE std::shared_ptr<OptionGroup> ParameterConfig::addGroup(std::string name, bool isExclusive) {
    if (name.empty())
