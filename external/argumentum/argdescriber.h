...
public:
    ArgumentHelpResult describe_argument(const ParserDefinition& parserDef, std::string_view name) const;
...
private:
    std::string describeArguments(const Option& option, const std::vector<std::string>& metavar) const;
};
