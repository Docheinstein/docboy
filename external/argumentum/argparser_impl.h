...
ARGUMENTUM_INLINE ParseResult argument_parser::parse_args(const std::vector<std::string>& args, int skip_args) {
...
ARGUMENTUM_INLINE ParseResult argument_parser::parse_args(std::vector<std::string>::const_iterator ibegin,
...
ARGUMENTUM_INLINE ArgumentHelpResult argument_parser::describe_argument(std::string_view name) const {
