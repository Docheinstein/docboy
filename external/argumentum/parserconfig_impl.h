...
ARGUMENTUM_INLINE ParserConfig& ParserConfig::help_formatter(std::shared_ptr<IFormatHelp> pFormatter) {
...
ARGUMENTUM_INLINE std::shared_ptr<IFormatHelp> ParserConfig::Data::help_formatter(const std::string& helpOption) const {
