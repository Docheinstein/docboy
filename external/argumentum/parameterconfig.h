...
public:
    ...
    OptionConfigA<TTarget> add_parameter(TTarget& target, const std::string& name = "",
     ...
     */
    template <typename TTarget>
    OptionConfigA<TTarget> add(TTarget& target, const std::string& name = "", const std::string& altName = "") {
