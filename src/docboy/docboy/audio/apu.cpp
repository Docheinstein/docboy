...
void Apu::save_state(Parcel& parcel) const {
    PARCEL_WRITE_UINT64(parcel, sampling.ticks);
    PARCEL_WRITE_DOUBLE(parcel, sampling.next_tick);

    PARCEL_WRITE_UINT8(parcel, apu_clock);
    PARCEL_WRITE_BOOL(parcel, prev_div_edge_bit);
    PARCEL_WRITE_UINT8(parcel, div_apu);
#ifdef ENABLE_CGB
    PARCEL_WRITE_UINT8(parcel, div_apu_bit_selector);
#endif

    PARCEL_WRITE_UINT8(parcel, nr10.pace);
    PARCEL_WRITE_BOOL(parcel, nr10.direction);
    PARCEL_WRITE_UINT8(parcel, nr10.step);
    PARCEL_WRITE_UINT8(parcel, nr11.duty_cycle);
    PARCEL_WRITE_UINT8(parcel, nr11.initial_length_timer);
    PARCEL_WRITE_UINT8(parcel, nr12.initial_volume);
    PARCEL_WRITE_BOOL(parcel, nr12.envelope_direction);
    PARCEL_WRITE_UINT8(parcel, nr12.sweep_pace);
    PARCEL_WRITE_UINT8(parcel, nr13.period_low);
    PARCEL_WRITE_BOOL(parcel, nr14.trigger);
    PARCEL_WRITE_BOOL(parcel, nr14.length_enable);
    PARCEL_WRITE_UINT8(parcel, nr14.period_high);
    PARCEL_WRITE_UINT8(parcel, nr21.duty_cycle);
    PARCEL_WRITE_UINT8(parcel, nr21.initial_length_timer);
    PARCEL_WRITE_UINT8(parcel, nr22.initial_volume);
    PARCEL_WRITE_BOOL(parcel, nr22.envelope_direction);
    PARCEL_WRITE_UINT8(parcel, nr22.sweep_pace);
    PARCEL_WRITE_UINT8(parcel, nr23.period_low);
    PARCEL_WRITE_BOOL(parcel, nr24.trigger);
    PARCEL_WRITE_BOOL(parcel, nr24.length_enable);
    PARCEL_WRITE_UINT8(parcel, nr24.period_high);
    PARCEL_WRITE_BOOL(parcel, nr30.dac);
    PARCEL_WRITE_UINT8(parcel, nr31.initial_length_timer);
    PARCEL_WRITE_UINT8(parcel, nr32.volume);
    PARCEL_WRITE_UINT8(parcel, nr33.period_low);
    PARCEL_WRITE_BOOL(parcel, nr34.trigger);
    PARCEL_WRITE_BOOL(parcel, nr34.length_enable);
    PARCEL_WRITE_UINT8(parcel, nr34.period_high);
    PARCEL_WRITE_UINT8(parcel, nr41.initial_length_timer);
    PARCEL_WRITE_UINT8(parcel, nr42.initial_volume);
    PARCEL_WRITE_BOOL(parcel, nr42.envelope_direction);
    PARCEL_WRITE_UINT8(parcel, nr42.sweep_pace);
    PARCEL_WRITE_UINT8(parcel, nr43.clock_shift);
    PARCEL_WRITE_BOOL(parcel, nr43.lfsr_width);
    PARCEL_WRITE_UINT8(parcel, nr43.clock_divider);
    PARCEL_WRITE_BOOL(parcel, nr44.trigger);
    PARCEL_WRITE_BOOL(parcel, nr44.length_enable);
    PARCEL_WRITE_BOOL(parcel, nr50.vin_left);
    PARCEL_WRITE_UINT8(parcel, nr50.volume_left);
    PARCEL_WRITE_BOOL(parcel, nr50.vin_right);
    PARCEL_WRITE_UINT8(parcel, nr50.volume_right);
    PARCEL_WRITE_BOOL(parcel, nr51.ch4_left);
    PARCEL_WRITE_BOOL(parcel, nr51.ch3_left);
    PARCEL_WRITE_BOOL(parcel, nr51.ch2_left);
    PARCEL_WRITE_BOOL(parcel, nr51.ch1_left);
    PARCEL_WRITE_BOOL(parcel, nr51.ch4_right);
    PARCEL_WRITE_BOOL(parcel, nr51.ch3_right);
    PARCEL_WRITE_BOOL(parcel, nr51.ch2_right);
    PARCEL_WRITE_BOOL(parcel, nr51.ch1_right);
    PARCEL_WRITE_BOOL(parcel, nr52.enable);
    PARCEL_WRITE_BOOL(parcel, nr52.ch4);
    PARCEL_WRITE_BOOL(parcel, nr52.ch3);
    PARCEL_WRITE_BOOL(parcel, nr52.ch2);
    ...
    PARCEL_WRITE_UINT8(parcel, ch1.volume);
    PARCEL_WRITE_UINT8(parcel, ch1.length_timer);
    PARCEL_WRITE_UINT8(parcel, ch1.trigger_delay);
    PARCEL_WRITE_BOOL(parcel, ch1.digital_output);
    PARCEL_WRITE_BOOL(parcel, ch1.just_sampled);
    PARCEL_WRITE_BOOL(parcel, ch1.tick_edge);
    PARCEL_WRITE_UINT8(parcel, ch1.wave.position);
    PARCEL_WRITE_UINT16(parcel, ch1.wave.timer);
    PARCEL_WRITE_UINT8(parcel, ch1.wave.duty_cycle);
    PARCEL_WRITE_BOOL(parcel, ch1.volume_sweep.direction);
    PARCEL_WRITE_UINT8(parcel, ch1.volume_sweep.countdown);
    PARCEL_WRITE_BOOL(parcel, ch1.volume_sweep.reloaded);
    PARCEL_WRITE_BOOL(parcel, ch1.volume_sweep.pending_update);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.pace_countdown);
    PARCEL_WRITE_UINT16(parcel, ch1.period_sweep.period);
    PARCEL_WRITE_UINT16(parcel, ch1.period_sweep.increment);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.restart_countdown);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.reload.countdown);
    PARCEL_WRITE_BOOL(parcel, ch1.period_sweep.reload.period_reloaded);
    PARCEL_WRITE_BOOL(parcel, ch1.period_sweep.reload.reload_period);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.recalculation.target_trigger_counter);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.recalculation.trigger_counter);
    PARCEL_WRITE_UINT8(parcel, ch1.period_sweep.recalculation.countdown);
    PARCEL_WRITE_BOOL(parcel, ch1.period_sweep.recalculation.instant);
    PARCEL_WRITE_UINT16(parcel, ch1.period_sweep.recalculation.increment);
    PARCEL_WRITE_BOOL(parcel, ch1.period_sweep.recalculation.from_trigger);

    PARCEL_WRITE_BOOL(parcel, ch2.dac);
    PARCEL_WRITE_UINT8(parcel, ch2.volume);
    PARCEL_WRITE_UINT8(parcel, ch2.length_timer);
    PARCEL_WRITE_UINT8(parcel, ch2.trigger_delay);
    PARCEL_WRITE_BOOL(parcel, ch2.digital_output);
    PARCEL_WRITE_BOOL(parcel, ch2.just_sampled);
    PARCEL_WRITE_BOOL(parcel, ch2.tick_edge);
    PARCEL_WRITE_UINT8(parcel, ch2.wave.position);
    PARCEL_WRITE_UINT16(parcel, ch2.wave.timer);
    PARCEL_WRITE_UINT8(parcel, ch2.wave.duty_cycle);
    PARCEL_WRITE_BOOL(parcel, ch2.volume_sweep.direction);
    PARCEL_WRITE_UINT8(parcel, ch2.volume_sweep.countdown);
    PARCEL_WRITE_BOOL(parcel, ch2.volume_sweep.reloaded);
    PARCEL_WRITE_BOOL(parcel, ch2.volume_sweep.pending_update);

    PARCEL_WRITE_UINT16(parcel, ch3.length_timer);
    PARCEL_WRITE_UINT8(parcel, ch3.sample);
    PARCEL_WRITE_UINT8(parcel, ch3.trigger_delay);
    PARCEL_WRITE_UINT8(parcel, ch3.digital_output);
#ifndef ENABLE_CGB
    PARCEL_WRITE_BOOL(parcel, ch3.just_sampled);
#endif
    PARCEL_WRITE_UINT8(parcel, ch3.wave.position.byte);
    PARCEL_WRITE_BOOL(parcel, ch3.wave.position.low_nibble);
    PARCEL_WRITE_UINT16(parcel, ch3.wave.timer);

    PARCEL_WRITE_BOOL(parcel, ch4.dac);
    PARCEL_WRITE_UINT8(parcel, ch4.volume);
    PARCEL_WRITE_UINT8(parcel, ch4.length_timer);
    PARCEL_WRITE_UINT8(parcel, ch4.trigger_delay);
    PARCEL_WRITE_BOOL(parcel, ch4.volume_sweep.direction);
    PARCEL_WRITE_UINT8(parcel, ch4.volume_sweep.countdown);
    PARCEL_WRITE_BOOL(parcel, ch4.volume_sweep.reloaded);
    PARCEL_WRITE_BOOL(parcel, ch4.volume_sweep.pending_update);
    PARCEL_WRITE_UINT16(parcel, ch4.lfsr.lfsr);
    PARCEL_WRITE_UINT8(parcel, ch4.lfsr.divider_countdown);
    PARCEL_WRITE_UINT16(parcel, ch4.lfsr.shift_counter);
    PARCEL_WRITE_UINT8(parcel, ch4.lfsr.divider);
    PARCEL_WRITE_UINT8(parcel, ch4.lfsr.shift);
    PARCEL_WRITE_BOOL(parcel, ch4.lfsr.width);
}
