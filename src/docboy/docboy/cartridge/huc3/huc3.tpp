...
template <uint32_t RomSize, uint32_t RamSize>
uint8_t* HuC3<RomSize, RamSize>::get_ram_data() {
    return ram;
}

template <uint32_t RomSize, uint32_t RamSize>
uint32_t HuC3<RomSize, RamSize>::get_ram_size() const {
    return RamSize;
}

template <uint32_t RomSize, uint32_t RamSize>
uint8_t HuC3<RomSize, RamSize>::read_rom_raw(uint16_t bank, uint16_t address) const {
    ASSERT(address < 0x8000);
...
template <uint32_t RomSize, uint32_t RamSize>
uint16_t HuC3<RomSize, RamSize>::get_rom_bank(uint16_t address) const {
    ASSERT(address < 0x8000);
...
template <uint32_t RomSize, uint32_t RamSize>
uint8_t HuC3<RomSize, RamSize>::read_ram_raw(uint16_t bank, uint16_t address) const {
    ASSERT(address >= 0xA000 && address < 0xC000);
...
template <uint32_t RomSize, uint32_t RamSize>
uint16_t HuC3<RomSize, RamSize>::get_ram_bank(uint16_t address) const {
    ASSERT(address >= 0xA000 && address < 0xC000);
